...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("バック") action Rollback()
            ...
            textbutton _("クイックセーブ") action QuickSave()
...
screen navigation():
    ...
    vbox:
        ...
        if persistent.tomoe_ending == True and gui.cg_count != 0:

            textbutton "Gallery" action None #ShowMenu("gallery")

        textbutton _("クレジット") action ShowMenu("about")
        ...
        if renpy.variant("pc"):
            ...
            ## Web.
            textbutton _("やめる") action Quit(confirm=not main_menu)
